    ...
    >
      <div className="mx-auto grid max-w-[1440px] gap-8 lg:grid-cols-[minmax(0,1fr)_480px] lg:items-center">
        <div className="max-w-5xl">
          <div className="motion-fade-up mb-6 flex flex-wrap items-center gap-3 text-xs font-bold uppercase tracking-[0.18em] text-ember-100">
            <span className="h-px w-10 bg-ember-500" aria-hidden="true" />
            FireWatch field operations
          </div>
          <h1 className="motion-fade-up motion-delay-1 max-w-4xl text-4xl font-black leading-[1.05] tracking-tight md:text-5xl lg:text-6xl">
            เห็นควันเร็วขึ้น
          ...
          <div className="motion-fade-up motion-delay-3 mt-7 flex flex-col gap-3 sm:flex-row">
            <a
              className="group hover-lift inline-flex min-h-12 items-center justify-center gap-2 rounded-md bg-ember-600 px-5 py-3 text-sm font-bold text-white shadow-[0_18px_40px_rgb(234_88_12_/_0.28)] hover:bg-ember-700 hover:shadow-[0_22px_48px_rgb(234_88_12_/_0.34)]"
              href="#report"
            >
              แจ้งเหตุ
              <ArrowRight aria-hidden="true" className="transition-transform duration-200 group-hover:translate-x-1" size={18} />
            </a>
            <a
              className="group hover-lift inline-flex min-h-12 items-center justify-center gap-2 rounded-md border border-white/15 bg-white/[0.06] px-5 py-3 text-sm font-bold text-white hover:bg-white/10"
              href="#live-map"
            >
              ดูแผนที่สด
              <MapPinned aria-hidden="true" className="transition-transform duration-200 group-hover:-translate-y-0.5" size={18} />
            </a>
          </div>
        ...
        <div className="motion-fade-up motion-delay-2 relative hidden overflow-hidden rounded-lg border border-white/10 bg-[#0a1627] shadow-[0_30px_90px_rgb(0_0_0_/_0.35)] md:block">
          ...
          <div className="relative border-b border-white/10 p-4">
            <div className="mb-4 flex items-center justify-between gap-4">
              ...
              <span className="motion-pulse-soft grid h-11 w-11 place-items-center rounded-md border border-ember-100/20 bg-ember-600 text-white">
          ...
          <div className="relative p-4">
            ...
            <div className="motion-scan-line motion-fade-up relative mt-4 overflow-hidden rounded-md border border-white/10 bg-slate-950/55 p-4">
              ...
              <div className="relative h-44 overflow-hidden rounded-sm border border-white/10 bg-[linear-gradient(90deg,rgb(148_163_184_/_0.14)_1px,transparent_1px),linear-gradient(0deg,rgb(148_163_184_/_0.14)_1px,transparent_1px)] bg-[length:34px_34px]">
                <span className="motion-pulse-soft absolute left-[16%] top-[22%] h-3 w-3 rounded-full bg-ember-500 shadow-[0_0_0_8px_rgb(249_115_22_/_0.12)]" />
                <span className="motion-pulse-soft absolute left-[52%] top-[46%] h-3 w-3 rounded-full bg-canopy-500 shadow-[0_0_0_8px_rgb(16_185_129_/_0.12)]" />
                <span className="motion-pulse-soft absolute left-[72%] top-[28%] h-2.5 w-2.5 rounded-full bg-sky-400 shadow-[0_0_0_7px_rgb(56_189_248_/_0.12)]" />
